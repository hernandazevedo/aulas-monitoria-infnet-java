 ...
 * @author Arjan Tijms
 */
@FacesConverter("converters.ListConverterById")
public class ListConverterById implements Converter {
	
	List<ListConvertable> list;
	
	@Override
	public Object getAsObject(FacesContext ctx, UIComponent component, String value) {  
        if (value != null) {  
        	for (ListConvertable listValue : list) {
        		if(value.equals(String.valueOf(listValue.getId())))
        			return listValue;
        	}
        }  
        return null;  
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (value == null || value.toString().trim().isEmpty()) {
	    	...
	    	ListConvertable obj = (ListConvertable) value;  
            return obj.getId().toString(); 
        }  
  
	}
	
	public void setList(List<ListConvertable> list){
		this.list = list;
	}
